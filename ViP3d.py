...
class WeightedPermuteMLP(nn.Module):
    def __init__(self,dim,h_dim,w_dim,d_dim, seg_dim=8, qkv_bias=False, proj_drop=0.,res=False):
        super().__init__()
        self.res = res
        ...
        self.mlp_h=nn.Linear(dim*h_dim,dim*h_dim,bias=qkv_bias)
        self.mlp_w=nn.Linear(dim*w_dim,dim*w_dim,bias=qkv_bias)
        self.mlp_d=nn.Linear(dim*d_dim,dim*d_dim,bias=qkv_bias)
